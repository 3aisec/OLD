...
const sections = [
  ...
  },
  {
    ...
    content:
      "For any privacy-related inquiries, data access or correction requests, grievances, or concerns, please contact our Grievance Officer at temp_dpo@temp.temp. We acknowledge all requests within 48 hours and resolve them within 30 days as required under the Information Technology (Intermediary Guidelines and Digital Media Ethics Code) Rules, 2021 and the DPDPA.",
  },
];
